...
If only a warning is desired use -warn:BCW0028 (which also works when not in strict mode of course).
 ...
 Cedric Vivier
 added a comment - 12/Jul/09 3:34 PM Landed in rev. 3330 
...
Hide
 ...
 Cedric Vivier
 added a comment - 10/Jul/09 11:18 AM - edited 
...
Rodrigo, let's go for one then I guess we can add a general -erroraswarn:[W1:Wn] flag to handle what you suggest.
 ...
 Cedric Vivier
 added a comment - 10/Jul/09 11:18 AM - edited Daniel, most strict-mode features are already warnings, and you can use -warnaserror [:W1,Wn] or -nowarn [:W1,Wn] to fine-tune it to your wish Or even macros for that matter, using COmpilerParameters.SuppressWarning("BCW0000") etc.. 
...
Hide
 ...
 added a comment - 10/Jul/09 7:52 AM 
...
But there should be a way to make implicit downcasts errors into warnings. 
 ...
 Rodrigo B. de Oliveira
 added a comment - 10/Jul/09 7:52 AM (1) 
...
Hide
 ...
 Daniel Grunwald
 added a comment - 10/Jul/09 6:37 AM 
...
Though I've been thinking that all strict-mode features should be warnings so that the user can specify how to handle each case (treat warning as error, warning, ignore) - Microsoft handles the optional strong typing features in VB.NET this way. 
 ...
 Daniel Grunwald
 added a comment - 10/Jul/09 6:37 AM In strict mode, I'd say "1) simply forbid all implicit downcasts". 
...
Hide
 ...
 Cedric Vivier
 added a comment - 10/Jul/09 5:34 AM - edited 
...
Opinions? 
 ...
 Cedric Vivier
 added a comment - 10/Jul/09 5:34 AM - edited I'm thinking of three options right now wrt to implicit downcasts in strict context : 
...
Hide
 ...
 Cedric Vivier
 added a comment - 14/Jan/08 4:44 AM - edited 
...
What do you think? 
 ...
 Cedric Vivier
 added a comment - 14/Jan/08 4:44 AM - edited True. 
...
Hide
 ...
 Daniel Grunwald
 added a comment - 14/Jan/08 4:15 AM 
...
Although I would prefer if downcasts weren't implicit. 
 ...
 Daniel Grunwald
 added a comment - 14/Jan/08 4:15 AM This is not a bug. 
