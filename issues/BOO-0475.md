...
Hide
 ...
 Doug H
 added a comment - 08/Sep/05 11:22 AM 
...
I'm guessing maybe the raise one is best, although technically "pass" means an empty block. 
 ...
 Doug H
 added a comment - 08/Sep/05 11:22 AM If we have a try block with no except, should it be a syntax error, or should it add an except handler that re-raises, or an except that passes? 
