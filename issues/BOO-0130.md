...
I'll leave this for when I translate booc to boo and implement command line handling with Mono.GetOptions. 
 ...
 Rodrigo B. de Oliveira
 added a comment - 21/Nov/04 7:36 PM I'll leave this for when I translate booc to boo and implement command line handling with Mono.GetOptions.
...
booc.exe now outputs the file name as it received 
 ...
 Rodrigo B. de Oliveira
 added a comment - 19/May/05 11:50 PM booc.exe now outputs the file name as it received
