...
Hide
 ...
 Doug H
 added a comment - 10/Feb/06 7:26 PM 
...
So I just changed the test case. Everything works now. We can make another jira issue for the above issue if need be, but it is pretty obscure. 
 ...
 Doug H
 added a comment - 10/Feb/06 7:26 PM The peverify issue was because I was setting a superclass field from the constructor of a subclass before the subclass called super(). I.E.: 
...
Hide
 ...
 Doug H
 added a comment - 10/Feb/06 6:45 PM 
...
ov(1) 
 ...
 Doug H
 added a comment - 10/Feb/06 6:45 PM This patch fixes a lot of cases, but "nant test" shows a cdata error, which may mean a peverify error somewhere. I will try to work that out later, but thought I'd go ahead and post it here anyway. 
