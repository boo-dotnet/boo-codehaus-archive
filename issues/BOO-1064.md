...
Hide
 ...
 Dmitry Malyshev
 added a comment - 09/Apr/10 8:55 AM 
...
-vvv log of internal compiler error on "b.Foo()" call 
 ...
 Dmitry Malyshev
 added a comment - 09/Apr/10 8:55 AM -vvv log of internal compiler error on "b.Foo()" call
...
Hide
 ...
 Dmitry Malyshev
 added a comment - 09/Apr/10 8:54 AM 
...
If in the last line try to call "b.Foo()" directly the compiler crashes. 
 ...
 Dmitry Malyshev
 added a comment - 09/Apr/10 8:54 AM If in the last line try to call "b.Foo()" directly the compiler crashes.
...
Fixed in trunk. 
 ...
 Rodrigo B. de Oliveira
 added a comment - 20/Oct/09 2:55 PM Fixed in trunk.
...
Hide
 ...
 Cedric Vivier
 added a comment - 21/Jul/09 11:32 AM 
...
It works though if B explicitely says it implements I (which was not the case originally).
 ...
 Cedric Vivier
 added a comment - 21/Jul/09 11:32 AM Above still cannot compile on trunk, but fails in EmitAssembly instead (no MethodInfo attached to the B). 
It works though if B explicitely says it implements I (which was not the case originally).
...
Hide
 ...
 Greg Nagel
 added a comment - 02/Jul/08 5:34 PM 
...
Er, the version is wrong. I was thinking the assemblies in /bin were 8.2 for some reason. All these tests are done under r3010. 
 ...
 Greg Nagel
 added a comment - 02/Jul/08 5:34 PM Er, the version is wrong. I was thinking the assemblies in /bin were 8.2 for some reason. All these tests are done under r3010.
...
Hide
 ...
 Greg Nagel
 added a comment - 02/Jul/08 4:05 PM 
...
Patch attached; passes all the standard tests and this new one. 
 ...
 Greg Nagel
 added a comment - 02/Jul/08 4:05 PM Turns out it doesn't have anything to do with the others; just some control code which assumed that Assumption() could take an empty list. 
