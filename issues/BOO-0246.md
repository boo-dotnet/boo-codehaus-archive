...
*Implemented "DuckByDefault" in CompilerParameters to make the two above patches work properly and nonintrusively. 
 ...
 Arron Washington
 added a comment - 21/Mar/05 5:54 PM Three patches. 
...
For the record, my SVN is /that/ out of sync with the main repository. =D 
 ...
 Arron Washington
 added a comment - 21/Mar/05 5:58 PM For the record, my SVN is /that/ out of sync with the main repository. =D
...
test3() 
 ...
 Doug H
 added a comment - 24/Mar/05 7:10 PM This version of the patch also allows you to have duck-typed parameters by default, like in the test1 case below. 
...
BTW, I renamed DuckByDefault to Ducky to make it consistent with the command line option. 
 ...
 Rodrigo B. de Oliveira
 added a comment - 26/Mar/05 5:35 PM Patch applied. Thanks! 
...
Also, would it make sense to have a "ducky" attribute to turn on duckiness for a block? 
 ...
 Bill Wood
 added a comment - 05/Apr/05 10:19 AM The -ducky flag would be useful for the interactive shells, perhaps even more so. 
...
[assembly:Options(RawArrayIndexing:true, Debug:true, Ducky:true)] 
 ...
 Doug H
 added a comment - 05/Apr/05 1:44 PM " The -ducky flag would be useful for the interactive shells, perhaps even more so." 
...
Doug, is Ducky turned on for Booxw too? 
 ...
 Bill Wood
 added a comment - 05/Apr/05 2:00 PM Doug, is Ducky turned on for Booxw too?
