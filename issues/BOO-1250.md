...
Hide
 ...
 Python Tech
 added a comment - 15/Sep/09 6:16 AM 
...
Ok I found the problem. I registered AutoItX3.dll in command prompt. I added it from COM. Still can't see the functions but manually adding works. 
 ...
 Python Tech
 added a comment - 15/Sep/09 6:16 AM Ok I found the problem. I registered AutoItX3.dll in command prompt. I added it from COM. Still can't see the functions but manually adding works.
