...
This is my first patch for Boo, so I'd really like to hear your comments (coding style, bugs, etc.) 
 ...
 Avishay Lavie
 added a comment - 16/Sep/06 9:44 AM I've done some work on point #2 from here: http://groups.google.com/group/boolang/msg/4c49391b6778330f 
The attached patch allows for type inference in for-loops over types that implement IEnumerable&lt;T&gt;: 
...
Added testcases. 
 ...
 Avishay Lavie
 added a comment - 16/Sep/06 10:11 AM Added testcases.
...
+ Adds testcases for above issues and for BOO-763 (generic generators, which aren't yet supported). 
 ...
 Avishay Lavie
 added a comment - 27/Oct/06 11:53 AM Attached BOO-448 -2.patch – 
+ Resolves BOO-758 , BOO-760 , BOO-761 and BOO-762 . 
+ Adds testcases for above issues and for BOO-763 (generic generators, which aren't yet supported).
...
Thanks again! 
 ...
 Rodrigo B. de Oliveira
 added a comment - 27/Oct/06 12:44 PM Thanks for the patch, Avishay! I'm working on it right now. 
...
Also, Is there a quick and easy way to run all of the unit tests? (I'm using Windows with SharpDevelop 2.1) 
 ...
 Avishay Lavie
 added a comment - 27/Oct/06 1:08 PM Yes, I was sloppy with testing before committing. I apologize. 
Does the patch break anything? 
Also, Is there a quick and easy way to run all of the unit tests? (I'm using Windows with SharpDevelop 2.1)
...
By the way, the code is in. Great work! 
 ...
 Rodrigo B. de Oliveira
 added a comment - 27/Oct/06 1:18 PM The patch broke a very simple issue with the way generic types were presented in error messages. 
