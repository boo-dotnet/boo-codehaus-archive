...
Hide
 ...
 Norbert Nemec
 added a comment - 27/Oct/05 5:14 AM 
...
For the moment, boo could probably just define some standard complex type but keep everything modular enough that it could be easily replaced by a more standard version in .NET or somewhere else. 
 ...
 Norbert Nemec
 added a comment - 27/Oct/05 5:14 AM Just did a little research on this issue. Turns out, it is quite a tricky issue: there is no standard complex type anywhere in the standard libraries. Neither the .NET System, nor Mono define such a type. 
...
Hide
 ...
 Doug H
 added a comment - 27/Oct/05 10:23 AM 
...
print x+y //9+3i 
 ...
 Doug H
 added a comment - 27/Oct/05 10:23 AM If BOO-1 is added to boo, and if a units library were added to boo, like a boo.science.dll or something, I think adding a built-in complex number type would make sense too. 
...
Hide
 ...
 Doug H
 added a comment - 27/Oct/05 1:06 PM 
...
this version adds AfterStep listener just once 
 ...
 Doug H
 added a comment - 27/Oct/05 1:06 PM this version adds AfterStep listener just once
...
Hide
 ...
 added a comment - 31/Oct/05 7:37 PM 
...
svn://ckknight.no-ip.org/Science 
 ...
 Cameron Kenneth Knight
 added a comment - 31/Oct/05 7:37 PM I've been making a science library for boo that uses the unit literals, and I have included Complex number support for it. 
...
Hide
 ...
 Norbert Nemec
 added a comment - 02/Nov/05 1:45 AM 
...
However: neither of the two letters is used for any physical unit or as a type suffix for any type but complex in any other language (to my knowledge) So there is no harm in simply allowing both letters as synonyms. 
 ...
 Norbert Nemec
 added a comment - 02/Nov/05 1:45 AM Nice work! Would be great if this were to find its way into the standard library. 
