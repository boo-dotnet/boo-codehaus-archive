...
Here is the diff file of my changes. I also added Dispose() calls to the dialogs, because it is recommended that WinForms dialogs be disposed. 
 ...
 Joshua W. Biagio
 added a comment - 29/Aug/05 10:32 PM Here is the diff file of my changes. I also added Dispose() calls to the dialogs, because it is recommended that WinForms dialogs be disposed.
...
patch applied. Thanks! 
 ...
 Rodrigo B. de Oliveira
 added a comment - 03/Sep/05 7:22 AM patch applied. Thanks!
